...
- [Split text into individual characters](readme-en/SmartTextSplitter.md)
...
- [A floating memo palette for Illustrator](readme-en/AiMemoPalette.md)
...
- [Sets the auto-kerning method of the selected text to M…](readme-en/AutoKerning-Metrics.md)
- [Sets the auto-kerning method of the selected text to J…](readme-en/AutoKerning-MetricsRomanOnly.md)
- [Sets the auto-kerning method of the selected text to O…](readme-en/AutoKerning-Optical.md)
- [Sets the auto-kerning method of the selected text to O…](readme-en/AutoKerning-Optical30.md)
...
- [Decrease leading by ten whole steps (via auto-leading)](readme-en/AutoLeadingStep-10.md)
- [Randomizes the baseline shift, scale, rotation and kerning of each character](readme-en/AutoTouchType.md)
- [Select one circle (path) and one text object; the text…](readme-en/CirclePathTextRepeat.md)
- [A tool to create and adjust area type from point text,…](readme-en/ConvertToAreaTypeLikeButton.md)
- [Convert point text, path text, or text + shape into ar…](readme-en/ConvertToAreaTypeLikeButtonAccurateSize.md)
...
- [Convert point text, path text, or text + shape into ar…](readme-en/ImportAndApplyGraphicStylePalette.md)
...
- [Swaps the contents of two selected text objects](readme-en/SwapTextSpecial.md)
- [Merges multiple text items into a single area text box](readme-en/TextMergeToAreaBox-tab.md)
- [Convert point text or path text into area type while p…](readme-en/TextWithShapeToAreaTypeSimple.md)
- [Sets the tsume of the selected text to 30%](readme-en/Tsume30simple.md)
- [A docked palette that sets only the basic text-composi…](readme-en/TypeBasicsPalette.md)
...
- [Adds the selected objects to the existing group selected with them](readme-en/AddToGroup.md)
- [A docking palette that sets the vertical gap between t…](readme-en/AiAdjustVerticalGapPalette.md)
- [A persistent palette that aligns the selection to the…](readme-en/AiAlignToArtboardPalette.md)
...
- [Adds to a group, releases from groups, or groups each object, chosen in a dialog](readme-en/GroupMembership.md)
...
- [Aligns or groups Illustrator text frames row by row an…](readme-en/TextGridAligner.md)
- [Infers rows and columns from the selected objects, tol…](readme-en/TransposeGrid.md)
- [Groups the selection temporarily and centers it verti…](readme-en/VerticalCenterAlignAsGroup.md)
- [Reorders the stacking order of objects by position (X/…](readme-en/ZIndexSorter.md)
- [Swaps the center positions of two selected objects](readme-en/swap-2-objects.md)
...
- [Duplicates the selection, sends it behind, applies Off…](readme-en/AddOutlineOffsetPath.md)
- [Places a marker (auto-generated square / frontmost obj…](readme-en/AiAnchorPointMarker.md)
- [Builds rules (a grid or a frame) automatically from re…](readme-en/CenterLineConnectorFromRect.md)
- [Converts blacks built from RGB or CMYK into a stable K…](readme-en/ColorToK100Converter.md)
- [Creates rectangles matching the bounds of the selected…](readme-en/ConvertToRectangle.md)
- [Applies randomized transformations to the selected obj…](readme-en/KPTSketchyPalette.md)
- [A persistent palette that applies the "Convert to Shap…](readme-en/LEConvertToShapePalette.md)
...
- [Linked image management](readme-en/LinkedImageManagerPalette.md)
...
- [Fit artboard size to your objects](readme-en/FitArtboardWithMargin.md)
- [Splits selected image or objects into grid pieces usin…](readme-en/Slice2Artboards.md)
...
- [Paste into every open document at the same position](readme-en/PasteInAllDocs.md)
...
- [Show a dialog before execution so the processing condi…](readme-en/FlattenLayers.md)
- [Turns the active layer into a template layer (locked,…](readme-en/MakeTemplateLayer.md)
- [Turns the active layer's template attribute (locked, n…](readme-en/ToggleTemplateLayer.md)
- [Loads and runs a temporary action that gives the targe…](readme-en/bg-template-only.md)
...
- [Creates the smallest square path centered on the selec…](readme-en/ClipWithSquare.md)
...
- [Delete All Guides](https://github.com/swwwitch/illustrator-scripts/blob/master/jsx/guide/single-function/DeleteAllGuides.jsx)
...
- [Count objects in the selection and the whole document](readme-en/SelectionInspectorPalette.md)
...
- [An Illustrator script that always creates Japanese-sty…](readme-en/AddTrimMarkToCurrentArtboard.md)
- [Get the active view rotation angle (view rotation) of…](readme-en/AiSmartRotateViewPalette.md)
- [A utility that closes every floating palette running i…](readme-en/CloseAllPalettes.md)
- [A palette for changing the "constrain angle" preferenc…](readme-en/DirectPrefsPalette.md)
