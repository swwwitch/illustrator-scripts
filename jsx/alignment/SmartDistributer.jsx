...
(function () {
    ...
    */
    ...
    for (var b = 0; b < nudgeButtons.length; b++) nudgeButtons[b].preferredSize = [32, 24];
    ...
    function applyNudge(dx, dy) {
        ...
        runInMainEngine("nudge", dx, dy, getStepPoints() * multiplier, currentAnchor);
    }
    ...
    function workerMain(action, dx, dy, getStepPoints, anchor) {
        try {
            ...
            if (isSingleText(selection)) {
                return adjustSingleTextLeading(selection[0], dy, getStepPoints);
            }

            return distributeSelection(selection, dx, dy, getStepPoints, anchor);
        } catch (e) {
