...
var NEAR_WHITE_CMYK_TOTAL_MAX = 10;   // CMYK合成値（C+M+Y+K）がこの値以下で「ほぼ白」
var NEAR_WHITE_RGB_MIN = 230;         // RGBの各チャンネルがこの値以上で「ほぼ白」

/* ほぼ黒の除外しきい値 / Near-black exclusion thresholds */
var NEAR_BLACK_CMYK_TOTAL_MIN = 350;  // CMYK合成値（C+M+Y+K）がこの値以上で「ほぼ黒」
var NEAR_BLACK_K_MIN = 93;            // K単独がこの値(%)以上で「ほぼ黒」
var NEAR_BLACK_RGB_MAX = 32;          // RGBの各チャンネルがこの値以下で「ほぼ黒」
