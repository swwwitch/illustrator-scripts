...
var LABELS = {
  ...
  noSelection: {
    ja: "オブジェクトが選択されていません。" + String.fromCharCode(13) +
        "塗り色（フィル）または線色（ストローク）のあるオブジェクトを2つ以上選択してください。",
    en: "No objects are selected." + String.fromCharCode(13) +
        "Please select two or more objects with fill or stroke colors."
  },
  needTwoFill: {
    ja: "塗り色（フィル）または線色（ストローク）のあるオブジェクトを2つ以上選択してください。" + String.fromCharCode(13) +
        "※グループ/複合パス/テキストは再帰的に参照します。" + String.fromCharCode(13) +
        "※フィル/ストロークを対象にします。",
    en: "Please select two or more objects with fill or stroke colors." + String.fromCharCode(13) +
        "* Groups/compound paths/text are traversed recursively." + String.fromCharCode(13) +
        "* Both fill and stroke colors are included."
  },
  errorPrefix: {
    ja: "エラーが発生しました: ",
...
(function() {
    ...
    try {
        ...
        alert(L('errorPrefix') + oneLine(e.message));
    }
})();
