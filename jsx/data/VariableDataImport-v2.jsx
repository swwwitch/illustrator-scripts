...
(function () {
    ...
    */
    ...
    function performImport(targetDoc, layout, isPreview) {
        ...
        var origin = computeCenteredGridOrigin(canvasBounds, cellWidth, cellHeight, gap, columnCount, dataRows.length);
        var deltaX = origin.left - placementRect[0];
        var deltaY = origin.top - placementRect[1];
        templateArtboard.artboardRect = [origin.left, origin.top, origin.left + cellWidth, origin.top - cellHeight];
