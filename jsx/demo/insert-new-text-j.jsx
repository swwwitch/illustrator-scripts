...
Creates a point text with a Japanese font at the center of the current view, centers the paragraph,
...
// 基本情報 / Basic info
// =========================================
var SCRIPT_NAME     = "InsertNewTextJ";               /* スクリプト名 / script name */
...
var SCRIPT_README_JA   = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/InsertNewTextJ.md"; /* README（日本語） */
var SCRIPT_README_EN   = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/InsertNewTextJ.md"; /* README (English) */
...
(function() {
    ...
    // =========================================
    var TEXT_CONTENTS = "山路を登りながら"; /* 挿入する文言 / text to insert */
