...
function showDialog() {
    ...
    // ===== Keyboard shortcuts for mode (E/U/R/S/L) =====
    function addModeKeyHandler(dialog, rbEmbed, rbRelease, rbReset, rbKeisen, rbLink, onChanged) {
    ...
    // Keyboard shortcuts: 埋め込み(E) / 解除(U) / リセット(R) / ケイ線(S) / リンク(L)
    addModeKeyHandler(dlg, rbModeEmbed, rbModeRelease, rbModeReset, rbModeKeisen, rbModeLink, updatePanelState);
