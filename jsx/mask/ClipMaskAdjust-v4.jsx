...
/action-1 {
    ...
    var checkFaceDetect; // UI only / logic TBD
    ...
    // --- Face Detect (UI only / logic TBD) ---
    checkFaceDetect = tweakPanel.add("checkbox", undefined, L.faceDetect);
    checkFaceDetect.value = false;
