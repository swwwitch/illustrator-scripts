                ...
                try {
                    ...
                    if (file.open("w")) {
                        ...
                        if (lang === "ja") {
                            ...
                            file.writeln(LABELS.forcedBreaks.ja + " " + forcedBreakAll);
                            file.writeln("");
                            ...
                            file.writeln("透明");
                            file.writeln(LABELS.opacityLt100.ja + " " + opacityLt100All);
                            file.writeln(LABELS.blendNotNormal.ja + " " + blendNotNormalAll);
                            file.writeln("");
                            ...
                            file.writeln(LABELS.handles.ja + " " + handleCountAll);
                            file.writeln(LABELS.compoundPath.ja + " " + compoundPathAll);
                            file.writeln(LABELS.compoundShape.ja + " " + compoundShapeAll);
                        } else {
                            file.writeln("Misc");
                            ...
                            file.writeln("Forced Line Breaks: " + forcedBreakAll);
                            file.writeln("");
                            ...
                            file.writeln("Transparency");
                            file.writeln("Opacity < 100: " + opacityLt100All);
                            file.writeln("Blend Mode ≠ Normal: " + blendNotNormalAll);
                            file.writeln("");
                            ...
                            file.writeln("Handles: " + handleCountAll);
                            file.writeln("Compound Paths: " + compoundPathAll);
                            file.writeln("Compound Shapes: " + compoundShapeAll);
                        }
