...
(function () {
    ...
    // ===== 日付（panel） =====
    var pnlDate = gColR.add("panel", undefined, L("panelDate"));
    ...
    // 月（ユニット間マージン）panel
    var pnlMonthOuter = gCellMonth.add("panel", undefined, L("panelMonth"));
    ...
    // セル（panel）
    var pnlCell = gColL.add("panel", undefined, L("panelCell"));
    ...
    // フォントサイズ（2行4列）
    var pnlFontSize = gColL.add("panel", undefined, L("panelBasic") + "（" + textUnitLabel + "）");
    ...
    function refreshPreview() {
        ...
        buildCalendar(doc, base, PREVIEW_LAYER_NAME, fs, align, monthTitleAlign, fontName, sundayRed, holidayRed, cellW, cellH, showTopYear, includeYearInMonthTitle, monthTitleBottomBorder, topYearBottomMargin, monthCount, colCount, monthTitleMode, monthBottomMargin, weekdayBottomMargin, outerMarginX, outerMarginY, startFromJanuary, weekStartMonday, weekdayLabelMode, weekdayFontSize, monthFontSize, yearFontSize);
    ...
    function buildCalendar(doc, baseDate, layerName, fontSize, alignMode, monthTitleAlign, fontName, sundayRed, holidayRed, cellW, cellH, showTopYear, includeYearInMonthTitle, monthTitleBottomBorder, topYearBottomMargin, monthCount, colCount, monthTitleMode, monthBottomMargin, weekdayBottomMargin, outerMarginX, outerMarginY, startFromJanuary, weekStartMonday, weekdayLabelMode, weekdayFontSize, monthFontSize, yearFontSize) {
