...
プレビューを有効にすると、ダイアログを閉じずに結果を確認できます。

詳細は README を参照してください。

### Overview

Runs Release Compound Path, Unite, Expand Appearance, Ungroup and Offset Path on the selection in one pass.
With the preview enabled you can check the result without closing the dialog.
