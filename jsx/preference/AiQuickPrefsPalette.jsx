...
(function () {
    ...
    var UNITS = [
        { label: "in",    pointsPerUnit: 72,               decimals: 3, popup: true },   /* 0 */
        { label: "mm",    pointsPerUnit: 72 / 25.4,        decimals: 1, popup: true },   /* 1 */
        { label: "pt",    pointsPerUnit: 1,                decimals: 1, popup: true },   /* 2 */
        { label: "pica",  pointsPerUnit: 12,               decimals: 2, popup: true },   /* 3 */
        { label: "cm",    pointsPerUnit: 72 / 2.54,        decimals: 2, popup: true },   /* 4 */
        { label: "Q",     pointsPerUnit: 72 / 25.4 * 0.25, decimals: 1, popup: true },   /* 5 */
        { label: "px",    pointsPerUnit: 1,                decimals: 1, popup: true },   /* 6 */
        { label: "ft/in", pointsPerUnit: 72 * 12,          decimals: 4, popup: false },  /* 7 */
        { label: "m",     pointsPerUnit: 72 / 25.4 * 1000, decimals: 4, popup: false },  /* 8 */
        { label: "yd",    pointsPerUnit: 72 * 36,          decimals: 4, popup: false },  /* 9 */
        { label: "ft",    pointsPerUnit: 72 * 12,          decimals: 4, popup: false }   /* 10 */
    ];
    ...
    function getUnitDecimals(unitCode) {
        return getUnitByCode(unitCode).decimals;
    }
