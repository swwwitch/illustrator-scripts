...
- Drawing: Real-time Drawing & Editing

### 更新履歴 / Change Log

- v1.7.1 (20260627): 「その他」を「コピー&ペースト」へ改称し、「描画」パネルを新設（リアルタイムの描画と編集を移動）。描画パネルに「GPUプレビューを更新」ボタンを追加。
...
(function () {
    ...
    var LABELS = {
        ...
        button: {
            ...
            refreshGpuPreview: { ja: "GPUプレビューを更新", en: "Refresh GPU Preview" }
        },
        color: {
    ...
    function main() {
        ...
        var checkboxPastePlain = addBooleanCheckbox(copyPastePanel, 'checkbox.pastePlain', 'plugin/FileClipboard/pasteWithoutFormatting');

        /* コピー元のレイヤーにペースト / Paste remembers layers */
        var checkboxPastePreserve = addBooleanCheckbox(copyPastePanel, 'checkbox.pastePreserve', 'layers/pastePreserve');
        ...
        var checkboxRealtime = addBooleanCheckbox(drawingPanel, 'checkbox.realtimeDrawing', 'LiveEdit_State_Machine');
