...
var SCRIPT_README_JA = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/PresetManager-artboards.md"; /* README（日本語） */
var SCRIPT_README_EN = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/PresetManager-artboards.md"; /* README (English) */
...
(function () {
    ...
    */
        var dialog = new Window("palette", getLabel("dialogTitle") + " " + SCRIPT_VERSION);
    ...
    */
        ...
        var btnClose = rightGroup.add("button", undefined, getLabel("OK"), {
            name: "ok"
        });
