    ...
    function drawBackgroundRects(targetItem, addOverallFrame, addDivider, addFillLeft, addFillRight, strokeWidthValue, offsetPt, splitDirection, perCorner, pillShape) {
        ...
        if (isVertical) {
            ...
            if (perCorner) {
                ...
                if (rect1) { applyMultiCornerRounding(rect1, ['tl', 'tr'], pillR); doc.selection = [rect1]; app.executeMenuCommand('Live Pathfinder Add'); }
                if (rect2) { applyMultiCornerRounding(rect2, ['bl', 'br'], pillR); doc.selection = [rect2]; app.executeMenuCommand('Live Pathfinder Add'); }
            }
        } else {
            ...
            if (perCorner) {
                ...
                if (rect1) { applyMultiCornerRounding(rect1, ['tl', 'bl'], pillR); doc.selection = [rect1]; app.executeMenuCommand('Live Pathfinder Add'); }
                if (rect2) { applyMultiCornerRounding(rect2, ['tr', 'br'], pillR); doc.selection = [rect2]; app.executeMenuCommand('Live Pathfinder Add'); }
            }
        }
