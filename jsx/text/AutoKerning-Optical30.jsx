...
// 基本情報 / Basic info
// =========================================
var SCRIPT_NAME     = "AutoKerning-Optical30";        /* スクリプト名 / script name */
var SCRIPT_VERSION  = "v1.0";                         /* バージョン / version */
var SCRIPT_AUTHOR   = "Masahiro Takano (@swwwitch)";  /* 作者 / author */
var SCRIPT_RELEASED = "";                             /* 最初のリリース日 / first release date */
var SCRIPT_UPDATED  = "";                             /* 更新日 / last updated */

var SCRIPT_README_JA = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/AutoKerning-Optical30.md"; /* README（日本語） */
var SCRIPT_README_EN = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/AutoKerning-Optical30.md"; /* README (English) */
...
(function () {
    ...
    /* 選択範囲にカーニング方式を適用（メトリクスのときのみプロポーショナルメトリクスをON、文字ツメは30%に） */
    function applyKerningToRanges(ranges, kerningMethod) {
        ...
        for (var i = 0; i < ranges.length; i++) {
            try {
                ...
                ranges[i].characterAttributes.Tsume = 30;
            } catch (e) {
                // 適用できない範囲はスキップ
            }
        }
