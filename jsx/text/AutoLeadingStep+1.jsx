...
選択したテキストの行送り（表示値）が 整数で1ステップ大きく するように、自動行送り量（％）を逆算して設定します。
...
Works out the auto-leading percentage that increases by one whole step the displayed leading of the selected text, and applies it.
...
// 基本情報 / Basic info
// =========================================
var SCRIPT_NAME     = "AutoLeadingStep+1";            /* スクリプト名 / script name */
var SCRIPT_VERSION  = "v1.0.0";                       /* バージョン / version */
var SCRIPT_AUTHOR   = "Masahiro Takano (@swwwitch)";  /* 作者 / author */
var SCRIPT_RELEASED = "";                             /* 最初のリリース日 / first release date */
var SCRIPT_UPDATED  = "";                             /* 更新日 / last updated */

var SCRIPT_README_JA = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/AutoLeadingStep+1.md"; /* README（日本語） */
var SCRIPT_README_EN = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/AutoLeadingStep+1.md"; /* README (English) */
