...
選択したテキストの行送り（表示値）が 整数で10ステップ大きく するように、自動行送り量（％）を逆算して設定します。
...
Works out the auto-leading percentage that increases by ten whole steps the displayed leading of the selected text, and applies it.
