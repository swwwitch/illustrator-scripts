...
function syncAreaOptionsEnabled() {
    chkMergeAreaText.enabled = !!safeGet(function () { return chkConvertToAreaText.value; }, false);
...
btnOK.onClick = function () {
    ...
    optKeepStyle = !!safeGet(function () { return chkKeepStyle.value; }, true);
    optConvertToAreaText = !!safeGet(function () { return chkConvertToAreaText.value; }, false);
    optMergeAreaText = optConvertToAreaText && !!safeGet(function () { return chkMergeAreaText.value; }, false);

    optGroupMode = safeGet(function () {
        return rbGroupNone.value ? "none" : (rbGroupLine.value ? "line" : "all");
    }, "none");
...
function main() {
    ...
    for (var k = 0; k < targets.length; k++) {
        ...
        if (!optKeepStyle) safeDo(function () { stripStyleKeepFirstFont(targets[k]); });
        safeDo(function () { splitTextFrameHighPrecision(targets[k]); });
    }
}
