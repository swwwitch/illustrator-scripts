#targetengine "TextFontPanelEngine"
#target illustrator
...
// 基本情報 / Basic info
// =========================================
var SCRIPT_NAME     = "TextFontPanelReinvented";      /* スクリプト名 / script name */
var SCRIPT_VERSION  = "v1.0.1";                       /* バージョン / version */
var SCRIPT_AUTHOR   = "Masahiro Takano (@swwwitch)";  /* 作者 / author */
var SCRIPT_RELEASED = "";                             /* 最初のリリース日 / first release date */
var SCRIPT_UPDATED  = "";                             /* 更新日 / last updated */

var SCRIPT_README_JA   = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/TextFontPanelReinvented.md"; /* README（日本語） */
var SCRIPT_README_EN   = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/TextFontPanelReinvented.md"; /* README (English) */
...
(function () {
    ...
    var LABELS = {
        dialog: {
            title: { ja: "文字組みパネル", en: "Type Panel" }
        },
        field: {
    ...
    var WORKER_FUNCS = [
        getTypeName, getSelectedTextRanges, resolveAutoKernType, applyKerningToRanges, applyTsumeToRanges,
    ...
    function getPresetFile() {
        return File(Folder.userData.fsName + "/TextFontPanelReinvented_presets.json");
    }
