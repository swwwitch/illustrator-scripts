...
https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/UnifiedTypePalette.md
...
https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/UnifiedTypePalette.md
...
var SCRIPT_ARTICLE_URL = "https://note.com/dtp_tranist/n/n4e2b79cf2891"; /* 紹介記事 / article URL */
...
(function () {
    ...
    var LABELS = {
        ...
        // 使用フォント一覧（DocumentFontListSelectorPalette 由来）/ Used-fonts list labels
        usedFonts: {
    ...
    // =========================================
    // 使用フォント一覧（DocumentFontListSelectorPalette 由来）/ Used-fonts list (ported from DocumentFontListSelectorPalette)
    ...
    // ライト／ダーク対応は ArtboardNavigatorPalette.jsx の方式 / Light/dark handling follows ArtboardNavigatorPalette.jsx
    // =========================================
    ...
    /* 使用フォントタブの中身を構築して参照を返す（DocumentFontListSelectorPalette 由来）
       Build the used-fonts tab contents and return refs (ported from DocumentFontListSelectorPalette) */
