...
(function () {
    ...
    var LABELS = {
        ...
        labelRansomTrackValue: { ja: "固定値:", en: "Fixed:" },
        unitRansomTrack: { ja: "(/1000em)", en: "(/1000em)" },
    ...
    var chkRansomTrack = pnlRansom.add("checkbox", undefined, L("chkRansomTrack"));

    var gRansomTrk = pnlRansom.add("group");
    gRansomTrk.orientation = "row";
    gRansomTrk.alignChildren = ["left", "center"];

    gRansomTrk.add("statictext", undefined, L("labelRansomTrackValue"));
    var edtRansomTrk = gRansomTrk.add("edittext", undefined, "200");
    edtRansomTrk.characters = 5;
    gRansomTrk.add("statictext", undefined, L("unitRansomTrack"));
    ...
    function isTouchAllOff() {
        try {
            return (!chkBase.value && !chkScale.value && !chkRot.value && !chkKern.value && !chkTrk.value);
        } catch (_) {
            return false;
        }
    }
    ...
    function updatePreview() {
        ...
        applyRandom(base, hPct, hPct, true, rot, kern, trk, seed, optFont);
    }
    ...
    chkTrk.onClick = function () { updatePreview(); updateRerunEnabled(); };
    ...
    chkFontRansom.onClick = function () {
        gRansomTrk.enabled =
            (chkFontRansom && chkFontRansom.value) &&
            (chkRansomTrack && chkRansomTrack.value);
        // NOTE: 犯行声明文風はOK時のみ実行（プレビュー不要）
        try {
            chkRansomTrack.enabled = (chkFontRansom && chkFontRansom.value);
        } catch (_) { }
        try { updateRerunEnabled(); } catch (_) { }
    };
