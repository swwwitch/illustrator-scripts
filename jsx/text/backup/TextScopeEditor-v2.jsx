...
シンボル内のテキストは編集対象外ですが、一覧表示には対応します。
...
Text inside symbols is not editable, but listing is supported.
...
function main() {
    ...
    function collectTextFromDocument(options) {
        ...
        function act_NewSymbol() {
            var str = '/version 3' + '/name [ 6' + ' 53796d626f6c' + ']' + '/isOpen 1' + '/actionCount 1' + '/action-1 {' + ' /name [ 3' + ' 4e6577' + ' ]' + ' /keyIndex 0' + ' /colorIndex 0' + ' /isOpen 1' + ' /eventCount 1' + ' /event-1 {' + ' /useRulersIn1stQuadrant 0' + ' /internalName (ai_plugin_symbol_palette)' + ' /localizedName [ 12' + ' e382b7e383b3e3839ce383ab' + ' ]' + ' /isOpen 1' + ' /isOn 1' + ' /hasDialog 1' + ' /showDialog 0' + ' /parameterCount 2' + ' /parameter-1 {' + ' /key 1835363957' + ' /showInPalette 4294967295' + ' /type (enumerated)' + ' /name [ 18' + ' e696b0e8a68fe382b7e383b3e3839ce383ab' + ' ]' + ' /value 2' + ' }' + ' /parameter-2 {' + ' /key 1919250540' + ' /showInPalette 4294967295' + ' /type (boolean)' + ' /value 1' + ' }' + ' }' + '}';
        ...
        function collectSymbolTexts() {
            ...
            for (var i = 0; i < siList.length; i++) {
                ...
                try {
                    ...
                    if (firstPass.length === 0 && tempLayer.pageItems.length > 0) {
                        doc.selection = null;
                        ...
                        if (sel.length > 0 && sel[0].typename === "SymbolItem") {
                            try {
                                sel[0].breakLink();
                            } catch (e2) { }
                        }
        ...
        function updateList() {
            ...
            /* シンボル内テキストを更新 / Update symbol text list */
            symbolListBox.removeAll();
            var symTexts = collectSymbolTexts();
