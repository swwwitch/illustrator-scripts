...
https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/ApplyLeadingPerTextFrame110.md
...
The leading is fixed at 110%.

See the README for details.
https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/ApplyLeadingPerTextFrame110.md
...
// 基本情報 / Basic info
// =========================================
var SCRIPT_NAME     = "ApplyLeadingPerTextFrame110";  /* スクリプト名 / script name */
var SCRIPT_VERSION  = "v1.0.1";                         /* バージョン / version */
var SCRIPT_AUTHOR   = "Masahiro Takano (@swwwitch)";  /* 作者 / author */
var SCRIPT_RELEASED = "";                             /* 最初のリリース日 / first release date */
var SCRIPT_UPDATED  = "2026-09-19";                             /* 更新日 / last updated */

var SCRIPT_README_JA = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/ApplyLeadingPerTextFrame110.md"; /* README（日本語） */
var SCRIPT_README_EN = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/ApplyLeadingPerTextFrame110.md"; /* README (English) */
        ...
        for (var i = 0; i < selectedItems.length; i++) {
            ...
            try {
                ...
                if (!hasShownLeadingError) {
                    alert(getLabel("alertLeadingApplyError") + "\r" + e.message);
