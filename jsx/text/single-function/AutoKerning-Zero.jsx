...
選択したテキストの自動カーニング方式を「0（カーニングなし）」に設定します。
プロポーショナルメトリクスはOFF、文字ツメは0%にします。

詳細は README を参照してください。
https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/AutoKerning-Zero.md

### Overview

Sets the auto-kerning method of the selected text to 0 (no kerning).
Proportional metrics are turned off and tsume is set to 0%.

See the README for details.
https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/AutoKerning-Zero.md
...
// 基本情報 / Basic info
// =========================================
var SCRIPT_NAME     = "AutoKerning-Zero";             /* スクリプト名 / script name */
var SCRIPT_VERSION  = "v1.0";                         /* バージョン / version */
var SCRIPT_AUTHOR   = "Masahiro Takano (@swwwitch)";  /* 作者 / author */
var SCRIPT_RELEASED = "";                             /* 最初のリリース日 / first release date */
var SCRIPT_UPDATED  = "";                             /* 更新日 / last updated */

var SCRIPT_README_JA = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/AutoKerning-Zero.md"; /* README（日本語） */
var SCRIPT_README_EN = "https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/AutoKerning-Zero.md"; /* README (English) */
...
(function () {
    ...
    function main() {
        ...
        applyKerningToRanges(targetRanges, AutoKernType.NOAUTOKERN);
    }
