...
[![Japanese](https://img.shields.io/badge/README-Japanese-4b8bbe.svg)](https://github.com/swwwitch/illustrator-scripts/blob/master/readme-ja/FontPresetPickerPalette.md)
...
It is the "Favorites" tab of UnifiedTypePalette.jsx, carved out into a standalone script.
...
- Presets are stored in `FontPresetPicker_presets.json`, directly under `Folder.userData`. This is a separate file from UnifiedTypePalette.jsx's `UnifiedTypePanel_presets.json`.
