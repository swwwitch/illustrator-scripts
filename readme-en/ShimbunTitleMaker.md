...
- A mask with the largest rectangle that leaves no corner missing after the rotation (the blurred fringe stays outside)
...
From front to back, everything is wrapped in one clip group:
...
- The dummy text repeats the opening of "I Am a Cat". Punctuation, small kana and long vowel marks are left out because line-start kinsoku would push them between lines.
