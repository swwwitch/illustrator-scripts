...
- Cut-edge shape from Flag, Rise, Straight or Jagged, with the bend set in percent and the jagged edge set by size and ridges
- Both cut edges share the same shape, so the gap stays even after closing up
...
| Flag / Rise / Straight / Jagged | Shape of the cut edge: Flag waves, Rise curves up toward one side, Straight slants in a straight line, Jagged zigzags |
...
| Size | Height of the Jagged ridges (ruler unit). 0 cuts straight across |
| Ridges | Number of Jagged ridges across the cut edge (0 to 100). 0 cuts straight across |
