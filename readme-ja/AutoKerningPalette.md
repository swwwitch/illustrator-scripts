...
[![English](https://img.shields.io/badge/README-English-4b8bbe.svg)](https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/AutoKerningPalette.md)
...
この2つだけを1枚の常駐パレットにまとめました。[統合文字組みパネル](UnifiedTypePalette.md)からこの部分だけを抜き出したもので、カーニングまわりだけを触りたいときはこちらのほうが軽快です。
...
- v1.1.3（2026-09-26）ファイル名を `AutoKerningPanel.jsx` から `AutoKerningPalette.jsx` に変更。
