...
- プリセット: 1x1 / auto / element / element+ / left / up-3 / clear space
...
- v1.4.4 (2026-09-23) 横線の自動判定を作り直し、ベースライン・ミーンライン・ディセンダーの推定精度を改善。下に伸びる文字が無いと文字の途中にベースラインが引かれる問題、アクセント・点・引用符にアセンダーやミーンラインが引っ張られる問題、小さい文字でベースラインが浮く問題を修正
- v1.4.2 (2026-09-17) ［プレビュー］を初期状態でONに変更。内部の命名・関数構成を整理し、各項目にツールチップを追加。［境界線を強調］が座標の誤差で外れる問題、キャンセルしても作成レイヤーだけが残る問題、線幅の単位がH／Qのときの換算を修正
- v1.4.1 (2026-04-10)
