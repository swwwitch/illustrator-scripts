...
[![English](https://img.shields.io/badge/README-English-4b8bbe.svg)](https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/PathInspectorPalette.md)
...
- v1.0.2（2026-09-26）ファイル名を `PathInspector.jsx` から `PathInspectorPalette.jsx` に変更。
