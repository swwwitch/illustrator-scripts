...
<img alt="グリッドの再配置ダイアログの外観" src="../png/ss-458-720-144-20260925-172312.png" width="40%" />
...
- 2026-09-25: v1.6.2 ［強制グリッド］でオブジェクトがアートボードの上端へ飛ぶ不具合を修正、ダイアログタイトルを「グリッドの再配置」に変更、行列入れ替えで同じセルに複数入るときのメッセージを改善、コード整理
