...
[![English](https://img.shields.io/badge/README-English-4b8bbe.svg)](https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/SmartAlignAndTile-yoko.md)
...
- キーオブジェクトを基準にした配置（未検出のときはチェックボックスをディム）
...
- v1.7.1 (20260905) : キーオブジェクトの自動判定を追加（キーオブジェクトを基準にして配置）
