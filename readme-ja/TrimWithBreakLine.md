...
<img alt="省略線でトリミングダイアログの外観" src="../png/ss-862-704-144-20260923-002405.png" width="50%" />
...
- v1.0.8 (20260925) : 切り口の形に「ギザギザ」（ジグザグ効果）を追加し、大きさと折り返しを指定できるようにした。切り口の形のラジオボタンを縦並びにした
