...
[![Direct](https://img.shields.io/badge/Direct%20Link-TypeBasicsPalette.jsx-ffcc00.svg)](https://github.com/swwwitch/illustrator-scripts/blob/master/jsx/text/TypeBasicsPalette.jsx)

[![English](https://img.shields.io/badge/README-English-4b8bbe.svg)](https://github.com/swwwitch/illustrator-scripts/blob/master/readme-en/TypeBasicsPalette.md)
...
UnifiedTypePalette.jsx からこれら5機能を抜き出して1画面に集約しています。
...
- v1.0.5（2026-09-26）ファイル名を `TypeBasicsPanel.jsx` から `TypeBasicsPalette.jsx` に変更。
